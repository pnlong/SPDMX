    ...
    md.write_text(
        "\n".join(
            [
                ...
                "## Train (upstream CLI)",
                "",
                "Training still uses YourMT3's own `train.py` / configs inside `amt/src`.",
                "Use our manifests as the mix+MIDI index for each arm:",
                "",
                "| Arm | Manifest |",
                "|-----|----------|",
                "| Slakh | `manifest_slakh.csv` |",
                "| SPDMX multitrack | `manifest_spdmx.csv` |",
                "| Union | `manifest_both.csv` |",
                "| Hour-matched SPDMX | `manifest_spdmx_hour_matched.csv` |",
                "",
