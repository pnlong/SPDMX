"""Paths for StreamGen (stream-music-gen) SPDMX scale-up pilots."""
...
DEV_SG_DIR = Path(OUTPUT_DIR) / DEV_DIR_NAME / EXPERIMENTS_DIR_NAME / "streamgen"
DEFAULT_CONFIG_PATH = SG_DIR / "config.yaml"
